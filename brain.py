    ...
    *,
    ...
    if style_profile:
        try:
            ...
            version = version or style_profile.get("version") or style_profile.get("model_id")
...
def draft_reply(
    ...
    *,
        ...
        try:
            ...
            if needs_knowledge:
                rag_context, rag_meta = get_rag_context(
                    ...
                    style_profile_version=(profile.get("model_id") if profile else None),
                    rag_mode=rag_mode,
                )
    ...
    if not replies:
        sp_version = profile.get("version") if profile else None
        replies, llm_error = _call_llm(
            ...
            prompt_version=PROMPT_VERSION,
            rag_meta=rag_meta,
            style_profile_version=sp_version,
        )
